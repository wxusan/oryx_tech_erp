...
const routes: Array<{ path: string; load: () => Promise<RouteModule> }> = [
  ...
  { path: 'src/app/api/debts/query/route.ts', load: () => import('@/app/api/debts/query/route') },
  ...
  { path: 'src/app/api/nasiya/[id]/return/route.ts', load: () => import('@/app/api/nasiya/[id]/return/route') },
  { path: 'src/app/api/nasiya/[id]/settlement/route.ts', load: () => import('@/app/api/nasiya/[id]/settlement/route') },
  ...
  { path: 'src/app/api/shop/staff/roles/[roleId]/route.ts', load: () => import('@/app/api/shop/staff/roles/[roleId]/route') },
  { path: 'src/app/api/shop/staff/roles/route.ts', load: () => import('@/app/api/shop/staff/roles/route') },
  ...
  { path: 'src/app/api/supplier-payables/[id]/payments/route.ts', load: () => import('@/app/api/supplier-payables/[id]/payments/route') },
