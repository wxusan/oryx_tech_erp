...
const uiMatrix = [
  ...
  ['src/app/(shop)/shop/nasiyalar/[id]/page.tsx', 'NASIYA_EDIT', 'NASIYA_PAYMENT_RECEIVE', 'NASIYA_PROFIT_WAIVE', 'NASIYA_DEFER', 'NASIYA_REMINDER_MANAGE', 'NASIYA_ARCHIVE', 'NASIYA_REOPEN'],
