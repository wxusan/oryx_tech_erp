...
const routeMatrix = [
  ...
  ['src/app/api/nasiya/route.ts', 'NASIYA_VIEW', 'NASIYA_EDIT', 'NASIYA_REMINDER_MANAGE', 'NASIYA_ARCHIVE', 'NASIYA_REOPEN', 'NASIYA_RETURN_REFUND'],
  ['src/app/api/nasiya/[id]/route.ts', 'NASIYA_VIEW', 'NASIYA_CREATE', 'NASIYA_EDIT', 'NASIYA_PAYMENT_RECEIVE', 'NASIYA_DEFER', 'NASIYA_REMINDER_MANAGE', 'NASIYA_ARCHIVE', 'NASIYA_REOPEN', 'NASIYA_RETURN_REFUND'],
  ['src/app/api/nasiya/[id]/payment/route.ts', 'NASIYA_PAYMENT_RECEIVE'],
  ['src/app/api/nasiya/[id]/settlement/route.ts', 'NASIYA_PAYMENT_RECEIVE', 'NASIYA_PROFIT_WAIVE'],
  ['src/app/api/nasiya/[id]/return/route.ts', 'NASIYA_RETURN_REFUND'],
...
const featureMatrix = [
  ...
  ['src/app/api/nasiya/[id]/settlement/route.ts', 'NASIYA_PAYMENT_RECEIVE', 'NASIYA'],
  ['src/app/api/nasiya/[id]/return/route.ts', 'NASIYA_RETURN_REFUND', 'NASIYA'],
...
const uiMatrix = [
  ...
  ['src/app/(shop)/shop/nasiyalar/[id]/page.tsx', 'NASIYA_EDIT', 'NASIYA_PAYMENT_RECEIVE', 'NASIYA_PROFIT_WAIVE', 'NASIYA_DEFER', 'NASIYA_REMINDER_MANAGE', 'NASIYA_ARCHIVE', 'NASIYA_REOPEN', 'NASIYA_RETURN_REFUND'],
