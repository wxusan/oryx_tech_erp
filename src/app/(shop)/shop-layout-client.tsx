...
const navLinks = [
  ...
  { href: '/shop/nasiyalar', label: 'Nasiyalar', icon: CreditCard, prefetch: true, permission: null, anyPermissions: ['NASIYA_VIEW', 'NASIYA_EDIT', 'NASIYA_RETURN_REFUND', 'NASIYA_REMINDER_MANAGE', 'NASIYA_ARCHIVE', 'NASIYA_REOPEN'], ownerOnly: false },
