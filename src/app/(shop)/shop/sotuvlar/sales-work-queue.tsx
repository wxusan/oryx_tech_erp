    ...
    <div className="mx-auto max-w-6xl space-y-5 p-6">
      ...
      <div className="overflow-x-auto rounded-lg border border-zinc-200 bg-white">
        <table className="w-full min-w-[780px] text-sm">
          ...
          <tbody>
            {query.isPending ? (
              <tr><td colSpan={7} className="p-8 text-center text-zinc-500">Yuklanmoqda...</td></tr>
              ...
              <tr><td colSpan={7} className="p-8 text-center text-zinc-500">Sotuv topilmadi</td></tr>
            )}
          </tbody>
        </table>
      </div>
