...
export const SHOP_PERMISSION_CATALOG: readonly ShopPermissionCatalogItem[] = [
  ...
  { code: 'NASIYA_ARCHIVE', label: 'Nasiyani arxivlash', description: 'Mos nasiyani sabab bilan arxivlash', featureCode: 'NASIYA', ownerOnly: false, retired: false, group: 'NASIYA', risk: 'DESTRUCTIVE', staffManagerDelegable: false, legacyOperational: false },
