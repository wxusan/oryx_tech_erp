...
| F-015 | Olib mobile cards added; shell identity and route resilience remain | Olib UI, layouts, route segments | Finish real server-seeded identity, errors/loaders | 390/768/desktop and failure states | None | Low/medium | IN PROGRESS |
